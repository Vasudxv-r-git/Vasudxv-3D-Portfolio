...
export function MagicCard(props: MagicCardProps) {
  const {
    ...
    className,
    gradientSize = 250,
    gradientColor = "rgba(112, 66, 248, 0.4)",
    gradientOpacity = 0.8,
    gradientFrom = "rgba(112, 66, 248, 0.8)",
    gradientTo = "rgba(112, 66, 248, 0.2)",
    mode = "gradient",
  } = props;
  ...
  return (
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(rgba(3,0,20,0.37) 0 0) padding-box,
    ...
    >
      <div className="absolute inset-px z-20 rounded-[inherit] pointer-events-none" />
